<%@ Page Language="C#" AutoEventWireup="true" UnobtrusiveValidationMode="none" CodeBehind="Catalog.aspx.cs" Inherits="Holly_view.Catalog" %>
			...
			<div class="row">
					...
					<div class="main__title">
						...
						<div class="main__title-wrap">
							<div class="main__title-form">
								<asp:TextBox ID="TextBox1" runat="server" placeholder="Find movie"></asp:TextBox>
				...
				<div class="col-12">
					<div class="main__table-wrap">
						...
						<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Holly_ViewConnectionString %>" SelectCommand="SELECT [id], [name], [rating] FROM [movies]" DeleteCommand="DELETE FROM [movies] WHERE [id] = @id" InsertCommand="INSERT INTO [movies] ([name], [rating]) VALUES (@name, @rating)" ProviderName="<%$ ConnectionStrings:Holly_ViewConnectionString.ProviderName %>" UpdateCommand="UPDATE [movies] SET [name] = @name, [rating] = @rating WHERE [id] = @id">
                            <DeleteParameters>
						...
						<asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1" DataKeyNames="id">
							...
							<AlternatingItemTemplate>
                                <tr >
                                    ...
                                    <td>
                                       <asp:Label ID="Label1" class="main__table-text" runat="server" Text='<%#Eval("id") %>'></asp:Label>
                                    </td>
                                    <td>
                                       <asp:Label ID="Label2" class="main__table-text" runat="server" Text='<%#Eval("name") %>'></asp:Label> 

                                    </td>
                                    <td>
                                        <asp:Label ID="Label3" class="main__table-text" runat="server" Text='<%# Eval("rating") %>'></asp:Label> 
                                    </td>
									<td>
                            ...
                            <EmptyDataTemplate>
                                <table runat="server" style="color: lightgrey;">
                                    <tr>
                                        <td>The movie does not exist</td>
                                    </tr>
                                </table>
                            </EmptyDataTemplate>
                            <InsertItemTemplate>
